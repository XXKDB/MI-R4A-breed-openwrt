...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='home'' package/lean/default-settings/files/zzz-default-settings
...
sed -i "s/OpenWrt /24k/g" package/lean/default-settings/files/zzz-default-settings
...
sed -i '/set wireless.default_radio${devidx}.encryption=psk2/a\set wireless.default_radio${devidx}.key=36336418' package/kernel/mac80211/files/lib/wifi/mac80211.sh
